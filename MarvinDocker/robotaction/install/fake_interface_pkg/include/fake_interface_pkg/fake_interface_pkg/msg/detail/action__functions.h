...
#ifndef FAKE_INTERFACE_PKG__MSG__DETAIL__ACTION__FUNCTIONS_H_
#define FAKE_INTERFACE_PKG__MSG__DETAIL__ACTION__FUNCTIONS_H_
 ...
 * calls
 * fake_interface_pkg__msg__Action__init().
...
/**
 * It calls
 * fake_interface_pkg__msg__Action__fini()
 ...
 * fake_interface_pkg__msg__Action__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * fake_interface_pkg__msg__Action__Sequence__fini()
 * on the array,
...
#endif  // FAKE_INTERFACE_PKG__MSG__DETAIL__ACTION__FUNCTIONS_H_
