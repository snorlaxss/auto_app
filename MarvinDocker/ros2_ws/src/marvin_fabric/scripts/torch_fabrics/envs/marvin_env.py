...
class MarvinEnv(RobotEnv):
    def __init__(
        ...
        q_init = np.array([  135.203, -82.1603, -91.1483, -119.172, -10.875, -21.5403, -4.8665, -139.3306, -53.2261, 90.1719, -120.5461, 25.8314, -13.7977, 0.7604])
        q_init = q_init * np.pi / 180.0
    ...
    def default_config_task_map(self, qpos: torch.Tensor):
        default_config = torch.Tensor(self.q_init).double()
        return qpos - default_config
    
    def default_config_fabric(self, pos: torch.Tensor, vel: torch.Tensor):
        """
        Simple spring-damper fabric to pull joints to default configuration.
        """
        dc = 1.0  # 
        k = 2.0  # 
    ...
    def _set_fabrics(self):
        ...
        self.task_maps = {
            ...
            "default_config": self.default_config_task_map
        }
        self.fabrics = {
            ...
            "default_config": self.default_config_fabric
        }
        # self.jac_funcs = {
