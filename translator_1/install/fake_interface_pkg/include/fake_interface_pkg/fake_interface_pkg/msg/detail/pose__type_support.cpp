...
{
  new (message_memory) fake_interface_pkg::msg::Pose(_init);
}

void Pose_fini_function(void * message_memory)
{
  auto typed_message = static_cast<fake_interface_pkg::msg::Pose *>(message_memory);
  typed_message->~Pose();
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Pose_message_member_array[4] = {
  {
    ...
    offsetof(fake_interface_pkg::msg::Pose, position),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(fake_interface_pkg::msg::Pose, orientation),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(fake_interface_pkg::msg::Pose, obj_id),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(fake_interface_pkg::msg::Pose, obj_name),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Pose_message_members = {
  ...
  "Pose",  // message name
  4,  // number of fields
  sizeof(fake_interface_pkg::msg::Pose),
...
{
  return &::fake_interface_pkg::msg::rosidl_typesupport_introspection_cpp::Pose_message_type_support_handle;
}
