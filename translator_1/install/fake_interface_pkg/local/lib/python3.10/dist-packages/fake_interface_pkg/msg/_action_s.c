...
bool fake_interface_pkg__msg__action__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("fake_interface_pkg.msg._action.Action", full_classname_dest, 37) == 0);
  }
  fake_interface_pkg__msg__Action * ros_message = _ros_message;
  {  // description
...
PyObject * fake_interface_pkg__msg__action__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("fake_interface_pkg.msg._action");
