    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'fake_interface_pkg.msg.ObjectPose')
            logger.debug(
            ...
            from fake_interface_pkg.msg import Pose
...
class ObjectPose(metaclass=Metaclass_ObjectPose):
    ...
    _fields_and_field_types = {
        ...
        'poses': 'sequence<fake_interface_pkg/Pose>',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['std_msgs', 'msg'], 'Header'),  # noqa: E501
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['fake_interface_pkg', 'msg'], 'Pose')),  # noqa: E501
    )
