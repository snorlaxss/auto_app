...
#include "fake_interface_pkg/msg/detail/object_pose__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const fake_interface_pkg::msg::Pose &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  fake_interface_pkg::msg::Pose &);
size_t get_serialized_size(
  const fake_interface_pkg::msg::Pose &,
  size_t current_alignment);
size_t
...
cdr_serialize(
  const fake_interface_pkg::msg::ObjectPose & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  fake_interface_pkg::msg::ObjectPose & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  // Member: poses
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        fake_interface_pkg::msg::typesupport_fastrtps_cpp::max_serialized_size_Pose(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = fake_interface_pkg::msg::ObjectPose;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const fake_interface_pkg::msg::ObjectPose *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<fake_interface_pkg::msg::ObjectPose *>(
    untyped_ros_message);
...
{
  return &fake_interface_pkg::msg::typesupport_fastrtps_cpp::_ObjectPose__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, fake_interface_pkg, msg, ObjectPose)() {
  return &fake_interface_pkg::msg::typesupport_fastrtps_cpp::_ObjectPose__handle;
}
