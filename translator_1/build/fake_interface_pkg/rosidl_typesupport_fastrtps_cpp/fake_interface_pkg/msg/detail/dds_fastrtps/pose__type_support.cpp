...
#include "fake_interface_pkg/msg/detail/pose__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const fake_interface_pkg::msg::Pose & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  fake_interface_pkg::msg::Pose & ros_message)
{
  // Member: position
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = fake_interface_pkg::msg::Pose;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const fake_interface_pkg::msg::Pose *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<fake_interface_pkg::msg::Pose *>(
    untyped_ros_message);
...
{
  return &fake_interface_pkg::msg::typesupport_fastrtps_cpp::_Pose__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, fake_interface_pkg, msg, Pose)() {
  return &fake_interface_pkg::msg::typesupport_fastrtps_cpp::_Pose__handle;
}
