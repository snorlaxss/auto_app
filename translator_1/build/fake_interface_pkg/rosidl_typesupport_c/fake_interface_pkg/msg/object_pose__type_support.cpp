...
static const _ObjectPose_type_support_symbol_names_t _ObjectPose_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, fake_interface_pkg, msg, ObjectPose)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, fake_interface_pkg, msg, ObjectPose)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, fake_interface_pkg, msg, ObjectPose)() {
  return &::fake_interface_pkg::msg::rosidl_typesupport_c::ObjectPose_message_type_support_handle;
}
