...
static const _Pose_type_support_symbol_names_t _Pose_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, fake_interface_pkg, msg, Pose)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, fake_interface_pkg, msg, Pose)),
  }
};
...
get_message_type_support_handle<fake_interface_pkg::msg::Pose>()
{
  return &::fake_interface_pkg::msg::rosidl_typesupport_cpp::Pose_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, fake_interface_pkg, msg, Pose)() {
  return get_message_type_support_handle<fake_interface_pkg::msg::Pose>();
}
