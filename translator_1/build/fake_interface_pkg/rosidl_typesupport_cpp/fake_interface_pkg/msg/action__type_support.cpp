...
static const _Action_type_support_symbol_names_t _Action_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, fake_interface_pkg, msg, Action)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, fake_interface_pkg, msg, Action)),
  }
};
...
{
  return &::fake_interface_pkg::msg::rosidl_typesupport_cpp::Action_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, fake_interface_pkg, msg, Action)() {
  return get_message_type_support_handle<fake_interface_pkg::msg::Action>();
}
