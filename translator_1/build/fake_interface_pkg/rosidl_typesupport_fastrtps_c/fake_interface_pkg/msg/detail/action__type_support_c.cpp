...
#include "fake_interface_pkg/msg/detail/action__rosidl_typesupport_fastrtps_c.h"
...
#include "rosidl_runtime_c/string.h"  // action, description, goal
#include "rosidl_runtime_c/string_functions.h"  // action, description, goal

// forward declare type support functions


using _Action__ros_msg_type = fake_interface_pkg__msg__Action;
...
static uint32_t _Action__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_fake_interface_pkg__msg__Action(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = fake_interface_pkg__msg__Action;
    is_plain =
      (
...
static size_t _Action__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_fake_interface_pkg__msg__Action(
