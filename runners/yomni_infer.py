...
def process_frame(frame, depth_raw, genpose2, yolo, args, writer, frame_idx, depth_scale):
    # run YOLO
...
def main():
    ...
    try:
        while True:
            ...
            pose, length, infer_time = process_frame(frame, depth_raw, genpose2, yolo, args, writer, frame_idx, depth_scale)
            frame_idx += 1
