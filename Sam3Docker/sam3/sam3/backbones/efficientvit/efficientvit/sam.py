...
from sam3.backbones.efficientvit.utils import build_kwargs_from_config, get_device
...
def efficientvit_sam_l0(image_size: int = 512, **kwargs) -> EfficientViTSam:
    from sam3.backbones.efficientvit.efficientvit.backbone import efficientvit_backbone_l0
...
def efficientvit_sam_xl0(image_size: int = 1024, **kwargs) -> EfficientViTSam:
    from sam3.backbones.efficientvit.efficientvit.backbone import EfficientViTLargeBackbone
