        ...
        if rpn_head == 'centernet':
            ...
            if efficientdet is None:
                raise ModuleNotFoundError(
                    "projects.EfficientDet module is required for rpn_head='efficient_det'. "
                    "Clone the mmdetection repository with its projects directory or adjust your PYTHONPATH."
                )
