...
def determine_tracker(tracker_name):
    ...
    if tracker_name == "sam21pp-L":
        ...
        checkpoint = os.path.join(path_, "/home/snorlax/work/DAM4SAM/checkpoints/sam2.1_hiera_small.pt")
        ...
        checkpoint = os.path.join(path_, "/home/snorlax/work/DAM4SAM/checkpoints/sam2_hiera_large.pt")
        model_cfg = "sam2pp_hiera_l.yaml"
    elif tracker_name == "sam2pp-B":
        checkpoint = os.path.join(path_, "/home/snorlax/work/DAM4SAM/checkpoints/sam2_hiera_base_plus.pt")
        model_cfg = "sam2pp_hiera_b+.yaml"
    elif tracker_name == "sam2pp-S":
        checkpoint = os.path.join(path_, "/home/snorlax/work/DAM4SAM/checkpoints/sam2_hiera_small.pt")
